...
public class JDBCAccountDao implements AccountDao {
    ...
    private static final String SELECT_BY_USER_ID_AND_SORT_BY_FIELD_SQL = "SELECT * FROM account WHERE user_id = ? ORDER BY ";
    ...
    @Override
    public List<Account> findByClientIdAndSortByField(int userId, String field) {
        try (PreparedStatement ps = connection.prepareStatement(SELECT_BY_USER_ID_AND_SORT_BY_FIELD_SQL + field)) {
            ...
            DaoOperationException exception = new DaoOperationException("Cannot find accounts", e);
            logger.error("findByClientIdAndSortByField() failed", exception);
            throw exception;
        }
    }
